...
export class UserProfileComponent implements OnInit {
  ...
  private fullName = "Titus Vimal Raj";
  ...
  constructor(private _sharedModuleService: SharedModuleService, private _global: GlobalService, private _location: Location,
    private toastr: ToastrService, public _route: ActivatedRoute, private _router: Router, private _userSocketService: UserSocketService, 
